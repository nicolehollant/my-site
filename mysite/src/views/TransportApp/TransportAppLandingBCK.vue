    ...
    <v-content v-if="page=='landing'">
      <v-container fluid fill-height d-flex>
        ...
        <!-- </div> -->
            ...
            <div id="cardDiv">
                <v-layout column justify-center id="mainLayout"> <!-- align-left -->
      ...
      <v-container fluid fill-height style="z-index: 2; padding: 8px;">
          <v-layout column id="containerLayout">        
            <section>
                ...
                <v-layout d-flex wrap justify-center align-content-center id="mainLayout"> <!-- align-left -->
                    <!-- <v-card class="pa-3 ma-3" id="shuttleStopTile" tile > 
                        <h3 >Click me baby</h3>
                        <h4 id="cardH4">Next:Time</h4>
                    </v-card> -->
                    ...
                    <v-card id="shuttleStopTile" style="cursor: pointer" tile>
                      <h3>{{ item.stop }}</h3>
                      <!-- <h4 id="cardH4" v-if="item.times_weekday_north && item.times_weekday">N: {{convertTime2(nextTimeNorth(item))}}, S: {{convertTime2(nextTimeSouth(item))}}</h4> -->
                      ...
                      <!-- <h4 id="cardH4" v-if="item.times_weekday_north && item.times_weekday">North: {{convertTime2(nextTimeNorth(item))}}</h4>
                      <h4 id="cardH4" v-if="item.times_weekday_north && item.times_weekday">South: {{convertTime2(nextTimeSouth(item))}}</h4> -->
                ...
                <!-- <v-card style="text-align: center; width: 300px; margin: auto" class="pa-3 mt-3">poop</v-card> -->
            </section>
          </v-layout>
      </v-container>
    </v-content>
